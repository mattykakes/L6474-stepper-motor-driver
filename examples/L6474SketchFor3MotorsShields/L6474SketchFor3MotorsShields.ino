...
void setup()
{
  ...
  /* Get current position of shield 2*/
  ...
  /* Request shield 1 to run in FORWARD direction */
  ...
  /* Wait for shield 2 reaches its max speed */
  ...
  /* Select full step mode for shield 2 */
  myL6474.SelectStepMode(2, L6474_STEP_SEL_1);

  /* Set speed and acceleration of shield 2 to be consistent with full step mode */
